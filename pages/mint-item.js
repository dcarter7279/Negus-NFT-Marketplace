...
description:''})
	...
	async function createSale(url) {
		...
		contract = new ethers.Contract(nftmarketaddress, NegusMarket.abi, signer)
	...
	return (
		<div className='flex justify-center'>
			<div className='w-1/2 flex flex-col pb-12'>
				...
				className='font-bold mt-4 bg-gold-500 text-white rounded p-4 shadow-lg'>
					Mint NFT
				</button>
			</div>
		</div>
